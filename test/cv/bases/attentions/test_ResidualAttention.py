...
# -- coding: utf-8 --
# @Author zengxiaohui
# Datatime:8/27/2021 2:13 PM
# @File:test_ResidualAttention.py
import os
import torch
import torchvision
...
from python_developer_tools.cv.bases.attentions.ResidualAttention import ResidualAttention
...
class shufflenet_v2_x0_5M(nn.Module):
    def __init__(self,nc,pretrained=True):
        ...
        self.model_ft.fc = ResidualAttention(channel=num_ftrs, num_class=nc, la=0.2)

...
from python_developer_tools.cv.scheduler.warmup_lr_scheduler import WarmupCosineAnnealingLR
...
scheduler_2 = WarmupCosineAnnealingLR(optimizer_2, T_max=max_epoch, eta_min=0.02,name="linear",iters=100,factor=0.01)

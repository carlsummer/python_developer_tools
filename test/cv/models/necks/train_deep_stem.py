...
from python_developer_tools.cv.classes.micronet import MicroNet_msnx_dy6_exp4_4M_221
from python_developer_tools.cv.models.necks.deep_stem_layer import make_stem_layer
...
class shufflenet_v2_x0_5M(nn.Module):
    def __init__(self,nc,pretrained=True):
        ...
        self.deep_stem = make_stem_layer(3,24)

...
if "__main__" == __name__:
    ...
    url = 'https://nchc.dl.sourceforge.net/project/cmusphinx/sphinx4/5prealpha/sphinx4-5prealpha-src.zip'
    file_name = 'sphinx4-5prealpha-src.zip'
    # 开始下载文件
    download(url, file_name,each_size=1*MB)

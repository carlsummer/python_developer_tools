...
class AliPay(object):
    ...
    def __init__(self, appid, app_notify_url, app_private_key_path,
        ...
        # print(os.path.abspath(self.app_private_key_path))
...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        appid="2021000117652234",
        app_notify_url="http://127.0.0.1:8000/alipay/return/",
        app_private_key_path="../docs/alipay/keys/private_2048.txt",
        alipay_public_key_path="../docs/alipay/keys/alipay_key_2048.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,

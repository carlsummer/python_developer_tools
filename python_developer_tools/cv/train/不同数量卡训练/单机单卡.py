...
if __name__ == '__main__':
    #41.139999 %
    # /home/zengxh/anaconda3/envs/CreepageDistance/bin/python3.8 /home/zengxh/workspace/python_developer_tools/python_developer_tools/cv/train/不同数量卡训练/单机单卡.py
    starttime = time.time()
